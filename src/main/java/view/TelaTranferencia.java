...
public class TelaTranferencia extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Tela de transferência bancária");

        jLabel1.setText("Saldo disponível:");

        jButton2.setText("Cancelar");

        jLabel2.setText("Valor que deseja transferir:");
        ...
        jLabel5.setText("Nome do titular da conta:");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaTranferencia.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
